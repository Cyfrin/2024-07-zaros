...
interface ILogAutomation {
    /**
     * @notice method that is simulated by the upkeeps to see if any work actually
     * needs to be performed. This method does does not actually need to be
     * executable, and since it is only ever simulated it can consume lots of gas.
     * @dev To ensure that it is never called, you may want to add the
     * cannotExecute modifier from UpkeepBase to your implementation of this
     * method.
     ...
     * @return upkeepNeeded boolean to indicate whether the upkeep should call
